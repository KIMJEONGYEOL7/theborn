...
namespace account
{
    class P_FI_Z_THEBORN_FOUND_RPT_BIZ
    { 

        #region -> 조회(Search)
        public DataTable Search(object[] param)
        {
            //DataTable dt = DBHelper.GetDataTable("UP_FI_Z_THEBORN_FOUND_RPT_S", param);
            DataTable dt = DBHelper.GetDataTable("UP_FI_Z_THEBORN_FOUND_RPT_S1", param);
        ...
        #region -> 조회(Search1)
        public DataTable Search1(object[] param)
        {
            //DataTable dt = DBHelper.GetDataTable("UP_FI_Z_THEBORN_FOUND_RPT_S", param);
            DataTable dt = DBHelper.GetDataTable("UP_FI_Z_THEBORN_FOUND_RPT_S2", param);
            T.SetDefaultValue(dt);
        ...
        //        //                                    "AM_CLS", "ID_INSERT" };
        //        si.SpParamsUpdate = new string[] { "CD_COMPANY", "CD_DEPOSIT", "CD_USERDEF1", "NM_Z_USERDEF1", "CD_USERDEF2", "ID_UPDATE" };
